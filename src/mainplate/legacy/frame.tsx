 ...
 * May import: at, geometry, layer, outline. Must not import: time/.
 */
import {
  createContext,
  type ReactNode,
...
import type { Frame } from "../core/at"
import {
  angleToValue,
  type Degrees,
  DIAL_RADIUS,
...
import { frameBox, framePadding } from "../core/layer"
import { type Outline, type OutlineSpec, resolveOutline } from "../core/outline"
import { isSource, type Source } from "../core/source"

/**
 * The angular coordinate system a face establishes, plus its centre, nominal
 * radius and outline. Read it with `useFrame`.
 *
 * Declared in `core/at.ts` — `resolveAt` takes one, and the engine may not
 * import this layer — and re-exported here, where every consumer already
 * looks for it.
 */
export type { Frame }
