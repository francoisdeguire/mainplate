 ...
 * May import: arc-path, errors, frame, geometry, outline, source, ticks. Must not import: time/.
 *
...
import { arcPath } from "../core/arc-path"
import { bothAnchorsMessage, failSoft } from "../core/errors"
import type { DialUnits, DomainValue } from "../core/geometry"
